...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users_form WHERE email='{$email}'")) > 0) {
            $msg = "<div class='alert alert-danger'>{$email} - This email address has been already exists.</div>";
        } else {
            if ($password === $confirm_password) {
                $sql = "INSERT INTO users_form (name, email, password, code) VALUES ('{$name}', '{$email}', '{$password}', '{$code}')";
        ...
        <div class="container">
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="w3l_form align-self" style="background-image:url(images/80daae8ca857a6d85a2b0edb2847c4ca.jpg); background-size:cover ">
                        <div class="left_grid_info">
                            <!-- <img src="images/80daae8ca857a6d85a2b0edb2847c4ca.jpg" alt="" > -->
                        </div>
                    </div>
